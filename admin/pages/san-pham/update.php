...
$thSp_Get_By_Id = $th->ThuongHieu__Get_By_Id($math);
?>
    ...
    <form class="form-group" action="pages/san-pham/action.php?req=update" method="post">
        ...
        <div class="col">
            ...
            <div class="form-check form-check-inline">
                <input class="btn-check" type="radio" id="mathh<?= $math ?>" value="<?= $math ?>" name="math" <?= $math == $sanPham__Get_By_Id->math ? 'checked' : '' ?> <?= $maloai == $sanPham__Get_By_Id->maloai ? "onclick='d_update_obj()'" : "onclick='d_add_obj(`$item->maloai`)'" ?>>
                <label class="btn btn-outline-primary" for="mathh<?= $math ?>"><?= $thSp_Get_By_Id->tenth  ?></label>
            </div>
            <?php foreach ($thuongHieu__Get_All as $item) : ?>
                <div class="form-check form-check-inline">
                    <input class="btn-check" type="radio" id="math<?= $item->math ?>" value="<?= $item->math ?>" name="math" <?= $item->math == $sanPham__Get_By_Id->math ? 'checked' : '' ?>>
        ...
        <div class="col">
            ...
            <div class="form-check form-check-inline">
                <input class="btn-check" type="radio" id="maloai<?= $maloai ?>" value="<?= $maloai ?>" name="maloai" <?= $maloai == $sanPham__Get_By_Id->maloai ? 'checked' : '' ?> <?= $maloai == $sanPham__Get_By_Id->maloai ? "onclick='d_update_obj()'" : "onclick='d_add_obj(`$item->maloai`)'" ?>>
