        ...
        <form class="form-control" action="pages/action.php?req=update_password" method="POST" onsubmit="return validatePasswords()">
            ...
            <div class="input-field">
                ...
                <div class="password-wrapper">
                    <input class="input" type="password" name="password" id="password" minlength="6" maxlength="20" required  />
            ...
            <div class="input-field">
                <div class="password-wrapper">
                    <input class="input" type="password" name="confirm_password" id="confirm_password" minlength="6" maxlength="20" required />
