...
<body>
    ...
    <!-- <script src="../assets/vendor/fontawesome-free-6.5.2-web/js/all.min.js"></script> -->
    <!-- Vendor JS Files -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
    <!-- Geolocation -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBWzRuWS-rxMCENShE23x4Gh1f7R3vAL1Y" defer></script>
    <!-- <script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBWzRuWS-rxMCENShE23x4Gh1f7R3vAL1Y&loading=async&callback=initMap"></script> -->
