...
<div class="container">
    ...
    <div class="user-cards">
        <div class="user-card">
            ...
            <!-- <a href="../api_auth/pages/action.php?req=dang-xuat">Chỉnh sửa thông tin <i class="fas fa-cog"></i></a> -->
            <a href="../api_auth?pages=chinh-sua" class="edit-profile">
                Chỉnh sửa thông tin <i class="fas fa-cog"></i>
            </a>
            <!-- Nút đăng xuất -->
            <a href="../api_auth/pages/action.php?req=dang-xuat" class="logout-button">
